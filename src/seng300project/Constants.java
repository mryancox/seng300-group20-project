...
public interface Constants {
	...
	//After assigning reviewers, it moves to stage 3 and becomes visible to reviewers.
	
	//After receiving feedback from at least one reviewer, it moves to stage 4 and becomes 
	//visible in the admin's review feedback page, disappearing from reviewer's feedback page.
	
	//After feedback is reviewed and released, it moves to stage 5, visible in the author's review feedback page.
	
	//The author can start resubmitting here until the deadline. After resubmitting, it moves back to stage 3.
	
	//After passing deadline, it moves to stage 6, appearing in the admin's review final submissions page.
	
	//If accepted, it reaches stage 7 and disappears from all lists. It is still in the database.
